...
local DaddyTab = Window:MakeTab({
	Name = "Extra",
	Icon = "rbxassetid://4483345998",
	PremiumOnly = false
})
local Retards = Window:MakeTab({
	Name = "Trolls",
	Icon = "rbxassetid://4483345998",
	PremiumOnly = false
})
local CreditPerSon = Window:MakeTab({
	Name = "Credits",
	Icon = "rbxassetid://4483345998",
	PremiumOnly = false
})
local Invincible = Window:MakeTab({
	Name = "Patched Scripts",
	Icon = "rbxassetid://4483345998",
	PremiumOnly = false
})
local OrionTest = Window:MakeTab({
	Name = "Orion Test",
	Icon = "rbxassetid://4483345998",
	PremiumOnly = false
})
...
SBTab:AddToggle({
	Name = "Ghost Annoy Farming, Ghost Required",
	Default = false,
...
SBTab:AddToggle({
	Name = "Auto Kick when admin joins",
	Default = false,
	Callback = function(bool)
		antiAdmins = bool
...
SBTab:AddToggle({
	Name = "Bully People with Shukuchi",
	Default = false,
	Callback = function(bool)
		 autoShuk = bool
        if bool == true then
...
SBTab:AddToggle({
	Name = "Auto Invisible, Ghost Required",
	Default = false,
	Callback = function(bool)
		  autoInvis = bool
    ...
    SBTab:AddToggle({
	Name = "TP Farming, In development",
	Default = false,
	Callback = function(bool)
		 allFarming = bool
...
SBTab:AddToggle({
	Name = "Invisible Reverse Filtering Enable",
	Default = false,
	Callback = function(bool)
		Invis_Reverse = bool
    ...
    SBTab:AddParagraph("Notice","Slap-Aura is in development, may not work properly because the owner is fixing this")
    SBTab:AddToggle({
	Name = "Slap Aura",
	Default = false,
	Callback = function(bool) -- Fixing
    ...
    AntiTab:AddToggle({
	Name = "Anti-Caught (Better as Bacon)",
	Default = false,
	Callback = function(bool)
		 Auto_Remove = bool
    ...
    AntiTab:AddToggle({
	Name = "Anti-Cube Of Death (Use this if you have elude)",
	Default = false,
	Callback = function(bool)
		 if bool == true then
...
DaddyTab:AddButton({
    Name = "Comet Admin v2",
    Callback = function()
       loadstring(game:HttpGet("https://pastebin.com/raw/qUTtNnHL",true))()
    end})
    DaddyTab:AddButton({
    Name = "Dizzy Hub",
    Callback = function()
    ...
    DaddyTab:AddButton({
    Name = "Zazas Hub v3.2.5 Beta",
    Callback = function()
        --[[

            Skiddable Edition, Only for trusted Ppl!
			
			
															]]--


-- Made by Zaza&Drip_SogusLegends
-- Big Credit to Imakedirectlinks
print("Thank yall for using my script!")
-- Zaza will put tons of credit
-- Big W For Imakedirectlinks and Drip_SogusLegends
-- Owner is too lazy frfr
local AkaliNotif = loadstring(game:HttpGet("https://raw.githubusercontent.com/Kinlei/Dynissimo/main/Scripts/AkaliNotif.lua"))();
local Notify = AkaliNotif.Notify;
Notify({
Description = "Credit always goes to Owner";
Title = "Successfully Loaded Zaza Hub";
Duration = 10;
});
wait()
local args = {
    [1] = "Script is made by Zaza, Credit to Imakedirectlinks, sawnicskid 3706 / Coems Coder ",
    [2] = "All"
...
local Window = Library.CreateLib("Zaza's Hub v3.2.5", "Serpent")
local TabBalls = Window:NewTab("SB Section Zaza")
local SectionCummings = TabBalls:NewSection("Zaza Scripts")

SectionCummings:NewButton("Noclip/Mobile", "Click to Noclip", function()
local Noclip = nil
local Clip = nil
...
SectionCummings:NewButton("Fling GUI", "Noclip/Fly Required", function()
loadstring(game:HttpGet('https://pastebin.com/raw/r97d7dS0', true))()
end)
SectionCummings:NewButton("VHub", "great hub that i use everytime", function()

loadstring(game:HttpGet("https://raw.githubusercontent.com/V31nc/2642/Created/VHub"))()
end)
SectionCummings:NewButton("Fly", "Mobile", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/XNEOFF/FlyGuiV3/main/FlyGuiV3.txt"))()
end)
SectionCummings:NewButton("Click TP Tool", "Mobile", function()
local plr = game:GetService("Players").LocalPlayer
local mouse = plr:GetMouse()

local tool = Instance.new("Tool")
tool.RequiresHandle = false
tool.Name = "Endermen Tool :o"
...
SectionCummings:NewButton("Equip 2 Gloves", "Back client", function()
game.Players.LocalPlayer:Kick("You are already equipping a glove you silly billy")
end)
SectionCummings:NewButton("Da Hood Scripts", "DH", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/Zinzs/luascripting/main/canyoutellitsadahoodscriptornot.lua"))()
end)
SectionCummings:NewButton("Spam Ability Hub", "Orion source, Credit to Imakedirectlinks", function()
local OrionLib = loadstring(game:HttpGet('https://raw.githubusercontent.com/shlexware/Orion/main/source'))()
local Window = OrionLib:MakeWindow({Name = "SB Spam Hub v5.2 By D_SG", HidePremium = false,IntroText = "Welcome", SaveConfig = true, ConfigFolder = "OrionTest"})
local SBTab = Window:MakeTab({
	Name = "Abilities",
	Icon = "rbxassetid://4483345998",
	PremiumOnly = false
...
SBTab:AddButton({
	Name = "Spam Defense(T)",
	Callback = function()
      		local enabled = false  -- set initial state to disabled
...
SBTab:AddButton({
	Name = "Credit Drip_SogusLegend Before Using",
	Callback = function()
print("Coder")
end
})
end)
SectionCummings:NewButton("CFrame DH Hub", "CFrame Speed for Mobile", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/TeamSkid/RobloxScripts/main/neverlose"))()
end)
SectionCummings:NewButton("Slap Battles Hub", "More Anti's Than R2O", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/RandomScriptr3/gggggggg/main/lolez.txt", true))()
end)
SectionCummings:NewButton("God Mode", "Impossible you to die ( Health )", function()
loadstring(game:HttpGet("https://pastebin.com/raw/FwfNEqYz", true))()

end)
SectionCummings:NewButton("Kill GUI", "Tool Required", function()
...
ced.Text = "Made by F20R, credit to him"
...
SectionCummings:NewButton("Farm to get Bob", "REJOIN IF THIS NOT WORKING,  Credit to Imakedirectlinks", function()
    while true do
...
SectionCummings:NewButton("Farm Brick", "Autoclicker Recommended, Credit to Imakedirectlinks", function()
...
SectionCummings:NewButton("Slap Aura", "Patched", function()
    print("Can skid line 43 to put whatever u want")
end)
SectionCummings:NewButton("Aim Viewer", "Imakedirectlinks Script Author", function()
    loadstring(game:HttpGet('https://pastebin.com/raw/046wniar', true))()
end)
SectionCummings:NewButton("dizzy gui", "Dizzy Hub", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/dizyhvh/slap_battles_gui/main/0.lua"))()
end)
SectionCummings:NewButton("dizy", "A Slap Battles OP Script that still alive", function()
    loadstring(game:HttpGet('https://pastebin.com/raw/f1V6qVeW', true))()
end)
SectionCummings:NewButton("Press E TO noclip", "Quick Noclip for pc", function()
    noclip = false
...
SectionCummings:NewButton("Insta-250 FE (Not Kick Script +real)", "250, Patched", function()
    game:GetService("StarterGui"):SetCore("SendNotification",{
	Title = "Patched, At 2023", -- Required
	Text = "Thank you for using my script", -- Required
})
end)
-- Made by Zaza&Drip_SogusLegends
-- Big Credit to Imakedirectlinks
-- Zaza will put tons of credit
SectionCummings:NewButton("Anti-Kick", "Allows you to grind (Use First)", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/gsxvWvnj"))()
end)
SectionCummings:NewButton("No Ragdoll", "Its like tabbing but ur cam dont freeze", function()
while wait(0.50) do
game:GetService("ReplicatedStorage").Events.RagdollState:FireServer(false)
end
end)
SectionCummings:NewButton("Drip_SogusLegends Hub v16.1.0.1", "Drip_SogusLegends#3428 Script Author", function()
    loadstring(game:HttpGet('https://pastebin.com/raw/7eu16PvA',true))()
end)
SectionCummings:NewButton("AUTO KICK IF ADMIN JOINS", "USE RN!!, Patched", function()
game.Players.LocalPlayer:Kick("nice try kiddo")
end)
-- Made by Zaza&Drip_SogusLegends
-- Big Credit to Imakedirectlinks
-- Zaza will put tons of credit
SectionCummings:NewButton("21 aka Gambroski's/Cruptify Hub", "Imakedirectlinks Script Author", function()
    loadstring(game:HttpGet('https://pastebin.com/raw/zXbH2g4f',true))()
end)
SectionCummings:NewButton("Hide SB Tag", "Hide your name so u wouldnt get caught", function()

game:GetService("StarterGui"):SetCore("SendNotification",{
	Title = "Patched", -- Required
	Text = "Has been patched since now", -- Required
	Icon = "rbxassetid://1234567890" -- Optional
})
--soon
end)
SectionCummings:NewButton("v17 Hub", "Drip_SogusLegends#3428 Author", function()
    loadstring(game:HttpGet(('https://gist.githubusercontent.com/CatmemerAKAcatluga/c93f6158b2bbf729477381c657815616/raw/6319e357022979f73169fcd96de16fe30f660910/V17'), true ))()
end)
SectionCummings:NewButton("Hide SB Tag", "Hide your name so u wouldnt get caught", function()
...
SectionCummings:NewButton("Universal FE Scripts", "Useful for trolling", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/Dvrknvss/UniversalFEScriptHub/main/Script'))()
--made by dvrknvss
end)
SectionCummings:NewButton("Inf Yield", "EdgeIY Cmds Author", function()
 loadstring(game:HttpGet('https://pastebin.com/raw/p4KtFSMU',true))()
end)
SectionCummings:NewButton("Admin", "Dont... Speedhack...", function()
...
Mouse.Target:Destroy()
	...
	elseif cht:match(":trollinggui") then
		...
		elseif cht:match(":zaza") then
		loadstring(game:HttpGet('https://pastebin.com/raw/9JNSyHqJ', true))()
...
SectionCummings:NewButton("Opfinality", "Dont use speedhack, use at your own RISK ", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/w8HNfSWA", true))();
end)
SectionCummings:NewButton("1 Unmicrillion Slaps", "Unmicrillion is equivalent to 30004 zeros", function()
    --You can skid at line 530
game.Players.LocalPlayer.leaderstats.Slaps.Value = 9.99e+30003
end)
-- Made by Zaza&Drip_SogusLegends
-- Big Credit to Imakedirectlinks
-- Zaza will put tons of credit
SectionCummings:NewButton("Aim Bot DH Zaza", "Imakedirectlinks Script Author", function()
    --dh zaza loadstring 
loadstring(game:HttpGet("https://pastebin.com/raw/5JGaipW2", true))()
end)
SectionCummings:NewButton("(NOT SB) R15 EMOTE", "Universal/r15 games", function()
    --by sawnicskid#3706 and Drip_TrolusLegends#3847
loadstring(game:HttpGet("https://pastebin.com/raw/eCpipCTH"))()
end)
SectionCummings:NewButton("Admin Gloves (real)", "u will tp to how admin use the admin glove", function()
    game.Players.LocalPlayer:Kick("what the hell boy")
end)
SectionCummings:NewButton("Anti-AFK", "Mobile if they cant use inf yield", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/KazeOnTop/Rice-Anti-Afk/main/Wind", true))()
end)
SectionCummings:NewButton("Anti-Void", "WORKING", function()
      if noVoid == true then
...
local ESection = ExtraTab:NewSection("Extra Hubs")

ESection:NewButton("C00lkid", "C00lkid Script, Backdoor sCRIPT!", function()
loadstring(game:HttpGet('https://pastebin.com/raw/6PwfSzJi',true))()
end)
ESection:NewButton("Get Error", "TROLLED BACK CLIENT XD :)", function()
--Skiddable
game.Players.LocalPlayer.leaderstats.Slaps.Value = 20000
end)
ESection:NewButton("Sawnic Admin", "Sawnic#3706", function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/CatmemerAKAcatluga/Slap-Battles-Dev/main/Turned%20Infinite%20Yield%20to%20Sawnic%20Admin%20(real).txt',true))()
end)
ESection:NewButton("1x1x1x1 Hack", "Backdoor Script", function()
-- Gui to Lua
-- Version: 3.
-- Instances:
...
local CTab = Window:NewTab("Credit House")
local CSection = CTab:NewSection("Credits")

CSection:NewButton("Zaza", " (Owner), click to rejoin", function()
    game.Players.LocalPlayer:Kick("Zaza's Hub")
    print('owner')
end)

CSection:NewButton("Drip_SogusLegends#3428", "The one who did everything (Clickable Hub)", function()
    loadstring(game:HttpGet('https://pastebin.com/GErm3fjx',true))()
    print('Coder Mega')
end)
CSection:NewButton("Imakedirectlinks/sawnicskid#3706", "A friend ofc", function()
    print('Feind')
game.Players.LocalPlayer:Kick("Unexpected Gui, Report to Tencell server if you have problem")
end)
CSection:NewButton("Patched Bonus Hub, SB v15.4", "a", function()
    print('Feind')
game.Players.LocalPlayer:Kick("Banned For Exploiting. Reason: Unexpected Client GUI")
end)
-- Made by Zaza&Drip_SogusLegends
-- Big Credit to Imakedirectlinks
-- Zaza will put tons of credit
...
noclip() -- to toggle noclip() and clip()
    ...
    DaddyTab:AddButton({
    Name = "Fling Gui (Need to Noclip first)",
    Callback = function()
        loadstring(game:HttpGet('https://pastebin.com/raw/r97d7dS0', true))()
    end})
    DaddyTab:AddButton({
...
Retards:AddToggle({
	Name = "Spam Thanos Sound FE (Earrape!)",
	Default = false,
	Callback = function(bool)
     autoThanos = bool
...
Retards:AddToggle({
	Name = "Spam Ping Pong (Need Ping Pong) FE",
	Default = false,
	Callback = function(bool)
     spamBall = bool 
...
Retards:AddToggle({
	Name = "Autofarm GUI Troll",
	Default = true,
	Callback = function(bool)
     loadstring(game:HttpGetAsync("https://pastebin.com/raw/Tk7BYCrr"))()
end
})
Retards:AddToggle({
	Name = "Invisible Troll (Need Ghost)",
	Default = false,
	Callback = function(bool)
     autoInvis = bool
...
Retards:AddToggle({
	Name = "Spam Space Sound Ability FE",
	Default = false,
	Callback = function(bool)
     spamSpace = bool
...
CreditPerSon:AddToggle({
	Name = "sawnicskid#3706",
	Default = false,
	Callback = function()
     setclipboard('sawnicskid#3706')
 
     game:GetService("StarterGui"):SetCore("SendNotification",{
	Title = "Copied to Clipboard!", 
	Text = "Big credit to him!", 
})
     end
})
CreditPerSon:AddToggle({
...
CreditPerSon:AddToggle({
	...
	Callback = function()
     ...
     game:GetService("StarterGui"):SetCore("SendNotification",{
	Title = "Copied to Clipboard!", 
	Text = "Big credit to him too :)", 
})
     end
})
CreditPerSon:AddToggle({
	Name = "Anonymous_III/VI/II/XI#3428",
	Default = false,
...
print("RTX Graphics loaded \n created by You")
     setclipboard('Anonymous_III/VI/II/XI#3428')
     game:GetService("StarterGui"):SetCore("SendNotification",{
	Title = "Copied to Clipboard!", 
	Text = "Massive Coder", 
     })
...
OrionLib:MakeNotification({
	Name = "No error! Successful",
	Content = "Successfully Loaded Slapper Hub",
	Image = "rbxassetid://4483345998",
	Time = 10
})
Invincible:AddToggle({
	Name = "Get Admin Gloves",
	Default = false,
	Callback = function()
