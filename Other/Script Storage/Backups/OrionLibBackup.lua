...
local Success, Response = pcall(function()
	Icons = HttpService:JSONDecode(game:HttpGetAsync("https://github.com/evoincorp/lucideblox/raw/master/src/modules/util/icons.json")).icons
end)

if Success then
    Icons = HttpService:JSONDecode(game:HttpGetAsync("https://github.com/evoincorp/TERIHAX/raw/master/src/modules/util/icons.json")).icons
else
